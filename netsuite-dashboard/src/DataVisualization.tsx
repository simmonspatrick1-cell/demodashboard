    ...
    <div className={`${className} space-y-6`}>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex items-center space-x-2 w-full sm:w-auto">
          ...
          <select 
            ...
            className="text-sm border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 px-3 py-1 w-full sm:w-auto"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg border shadow-sm">
          <h4 className="text-sm font-medium text-gray-700 mb-4">Scenarios by Industry</h4>
        ...
        <div className="bg-white p-6 rounded-lg border shadow-sm">
          <h4 className="text-sm font-medium text-gray-700 mb-4">Customer Status Distribution</h4>
          <ResponsiveContainer width="100%" height={300}>
            <RechartsPie>
              <Pie
                data={statusData}
        ...
        <div className="bg-white p-6 rounded-lg border shadow-sm">
          <h4 className="text-sm font-medium text-gray-700 mb-4">Prompts by Category</h4>
          <ResponsiveContainer width="100%" height={300}>
        ...
        <div className="bg-white p-6 rounded-lg border shadow-sm">
          <h4 className="text-sm font-medium text-gray-700 mb-4">Budget Trends Over Time</h4>
          <ResponsiveContainer width="100%" height={300}>
